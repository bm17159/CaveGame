...
public class CrawlerMonsterController : MonoBehaviour
{
    ...
    private void Spawn()
    {
        // Instantiate a new monster at the initial position
        spawnedCrawler = Instantiate(Crawler, initialPos, Quaternion.identity);
        
        // Reset movement timer and activate movement flag
        elapsedTime = 0f;
        isMoving = true;
    }
